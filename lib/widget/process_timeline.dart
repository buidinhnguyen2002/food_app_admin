...
class ProcessTimelinePage extends StatefulWidget {
  ...
  const ProcessTimelinePage({super.key, required this.orderId});
  @override
...
class _ProcessTimelinePageState extends State<ProcessTimelinePage> {
  ...
  Widget build(BuildContext context) {
    _processIndex =
        Provider.of<OrderProvider>(context).getProcessById(widget.orderId);
      ...
      builder: TimelineTileBuilder.connected(
        ...
        oppositeContentsBuilder: (context, index) {
          return Padding(
            ...
            child: Image.asset(
              '${AssetConstants.basePathImages}status${index + 1}.png',
              width: 50.0,
